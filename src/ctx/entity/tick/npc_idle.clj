(ns ctx.entity.tick.npc-idle
  (:require [ctx.entity.tick.npc-idle.choose-skill :as choose-skill]
            [ctx.entity.tick.npc-idle.create-effect-ctx :as create-effect-ctx]
