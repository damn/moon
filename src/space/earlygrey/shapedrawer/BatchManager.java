...
class BatchManager {
    ...
    // TODO these 3 methods never called
    public void update(int graphicsWidth) {
        update(true, graphicsWidth);
    }

    public void update(boolean updatePixelSize, int graphicsWidth) {
        if (updatePixelSize) updatePixelSize(graphicsWidth);
    }

    public float updatePixelSize(int graphicsWidth) {
        ...
        float newPixelSize = worldWidth / graphicsWidth;
