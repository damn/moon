(ns moon.game
  (:require [clojure.edn :as edn]
            ...
            [gdx.maps.tiled.tiled-map :as moon-tiled-map]
            [gdx.scenes.scene2d.actor :as actor]
            [gdx.scenes.scene2d.stage :as stage]
            [gdx.scenes.scene2d.ui.button :refer [is?]]
            [gdx.scenes.scene2d.ui.table :as table]
            [gdx.scenes.scene2d.ui.window :refer [title-bar?]]
            [gdx.utils.disposable :as disposable]
            [gdx.utils.viewport.viewport :refer [unproject]]
            ...
            [gdx.graphics.g2d.bitmap-font-data :as bitmap-font-data]
            [gdx.graphics.g2d.sprite-batch :as sprite-batch]
            [gdx.graphics.g2d.texture-region :as texture-region]
            [gdx.graphics.gl20 :as gl20]
            [gdx.graphics.glutils.pixmap-texture-data :as pixmap-texture-data]
            [gdx.graphics.texture :as texture]
            [gdx.graphics.texture.texture-filter :as texture-filter]
            ...
            [qrecord.core :as q]
            [reduce-fsm :as fsm]
            [gdx.graphics.g2d.shape-drawer :as shape-drawer])
  (:gen-class))
